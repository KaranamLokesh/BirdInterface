...
if(isset($_POST['submit_range'])){
  $from_date = $_POST['date_0'];
  $to_date = $_POST['date_1'];
$sql = "SELECT latitude,longitude,imageName FROM locations where date_of_upload > '".$from_date."' and date_of_upload<'".$to_date."'";
...
$sql = "SELECT latitude,longitude,imageName FROM locations where date_of_upload ='".$date."'";
$result = mysqli_query($mysqli, $sql);
...
console.log(longitude);
        ...
        function initialize()
        {
            ...
            var swBound = new google.maps.LatLng(lat-0.007,lon-0.007);
            var neBound = new google.maps.LatLng(lat+0.007,lon+0.007);
...
<div class="topnav">
  ...
  <a href="#">View Overlays</a>
  <a href="search_overlays.php">Search Overlays</a>
  <a class ="active" href="#">View Overlay Range</a>
</div>
